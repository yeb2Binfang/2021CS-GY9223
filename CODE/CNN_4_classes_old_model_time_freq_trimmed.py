# 10-fold cross-validation with the old model on the dataset and 4 classes
# PVHA, PVLA, NVHA, NVLA,
...
with plt.style.context("default"):
    ...
    plt.tight_layout()
    plt.savefig('FIGURES/trainTestDist_cnn_10fold_4_classes_time_freq_trimmed.pdf')
...
with plt.style.context("default"):
    ...
    plt.grid
    plt.savefig('FIGURES/accTrainVal_10foldCV_4classes_old_time_freq_trimmed.pdf')
...
plt.tight_layout()
plt.savefig('FIGURES/normCM_cnn_10fold_4_classes_old_time_freq_trimmed.pdf')
...
with plt.style.context("default"):
    ...
    plt.tight_layout()
    plt.savefig('FIGURES/accuracyTrainVal_cnn_10fold_4_classes_old_time_freq_trimmed.pdf')

# save model
h5_fn = ('MODELS/CNN_4_classes_old_model_time_freq_trimmed.h5')
model.save(h5_fn)

# 10-fold cross-validation with the old model on the dataset with 4 classes
# PVHA, PVLA, NVHA, NVLA,
...
with plt.style.context("default"):
    ...
    plt.tight_layout()
    plt.savefig('FIGURES/accuracyTrainVal_cnn_10fold_4_classes_old.pdf')

# save model
h5_fn = ('MODELS/CNN_4_classes_old_model.h5')
model.save(h5_fn)
